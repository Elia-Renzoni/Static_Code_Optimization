...
loop:
    BE r8, r9, LoopIfAnnidato
    LoopIfAnnidato:
    	LW  r13, 0(r10)
    	LW  r14, 0(r11)
    	BNE r14, r13, break		; TODO => da vedere se e' possibile fare un break - come nel C - oppure rendere la condizione falsa (quindi simulare il break).
    	ADD r10, r10, 8
    	ADD r11, r11, 8
    	BNE r7, r1, LoopIfAnnidato
    BE r8, r9, IfAnnidato
    IfAnnidato: 
    BE r7, r2, MemorizzaSpostamento
	MemorizzaSpostamento:
	LW r14, 0(r6)    
    BNE r6, r12, loop1
    BNE 				; TODO => ultimi due if del sorgente .C
